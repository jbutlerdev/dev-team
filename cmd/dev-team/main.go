...
func main() {
	...
	api.HandleFunc("/settings/mcp", handlers.HandleListMcpServers).Methods("GET")
    api.HandleFunc("/settings/mcp", handlers.HandleAddMcpServer).Methods("POST")
    api.HandleFunc("/settings/mcp", handlers.HandleRemoveMcpServer).Methods("DELETE")
